...
public class MatchDetails {
    ...
    public MatchDetails(Long matchId, LocalDate matchDate, LocalTime matchTime, String homeName, String awayName, String homeImg, String awayImg, Long homeScore, Long awayScore, String liveLink, Boolean alarm) {
