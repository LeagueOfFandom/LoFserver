...
public class CommunityController{
    ...
    public ResponseEntity<?> insertBoard(@RequestBody BoardDto boardDto) throws Exception {
    ...
    public ResponseEntity<?> getBoardDetail(@PathVariable("id") Long boardId)throws Exception {
